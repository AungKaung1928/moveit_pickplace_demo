...
```python
### Current values
Quaternion(x=0.0, y=0.0, z=0.0, w=1.0)  # Straight down
```
Common orientations:
```
...
```python
### Current values
max_velocity_scaling_factor = 0.1      # 10% speed
max_acceleration_scaling_factor = 0.1   # 10% acceleration
```
Range: 0.01 to 1.0
...
```python
### Current values
dimensions = [0.01, 0.01, 0.01]    # 1cm tolerance
```
